...
export default function LeadModal({ 
  ...
  const [formFields, setFormFields] = useState({
    ...
    cvTextContent: initialLead.cvTextContent || '',
                            ...
                            <div className="p-3 bg-slate-50 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2 text-left">
                              ...
                              {formFields.resumeUrl ? (
                                <div className="space-y-2.5">
                                  ...
                                  {lead.cvTextContent && (
                                    <div className="p-3 bg-indigo-50/50 dark:bg-slate-950/40 border border-indigo-100/60 dark:border-slate-800 rounded-xl text-xs space-y-1.5 text-left">
                                      <div className="flex items-center gap-1.5 text-indigo-600 dark:text-indigo-400 font-extrabold text-[10px] uppercase tracking-wider">
                                        ...
                                        AI Scanned CV Highlights
                                      </div>
                                      <div className="text-[10px] text-slate-600 dark:text-slate-300 leading-relaxed font-mono whitespace-pre-wrap max-h-40 overflow-y-auto pr-1">
                                        {lead.cvTextContent}
                                      </div>
                                    </div>
                                  )}
